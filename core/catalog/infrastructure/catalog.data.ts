...
export const CATALOG: readonly Product[] = [
  {
    ...
    name: "Tortuga",
    description:
      "Dije de tortuga en plata 925 con caparazón texturado a mano. Pieza maciza, terminación pulida espejo. Se entrega con bolsa sellada del drop.",
  ...
  },
  {
    ...
    name: "Veneciana 45",
    description:
      "Cadena veneciana de 45 cm, eslabón cuadrado de 2 mm. Plata 925 maciza con cierre mosquetón reforzado.",
  ...
  },
  {
    ...
    name: "Sello Negro",
    description:
      "Anillo sello de superficie plana con pátina negra en los bordes. Plata 925. Talles 16 a 22.",
  ...
  },
  {
    ...
    name: "Industrial",
    description:
      "Par de argollas de 14 mm, sección hexagonal. Plata 925 con acabado mate arenado.",
  ...
  },
  {
    ...
    name: "Eslabón",
    description:
      "Pulsera de eslabón grueso, 19 cm. Plata 925 maciza, 42 g. Cierre de seguridad doble.",
  ...
  },
  {
    ...
    name: "Llave",
    description:
      "Dije llave antigua fundido en plata 925. Terminación envejecida con relieve profundo.",
  ...
  },
  {
    ...
    name: "Cartier 50",
    description:
      "Cadena cartier de 50 cm, eslabón oval de 4 mm. Plata 925 maciza, pulido espejo.",
  ...
  },
  {
    ...
    name: "Martillada",
    description:
      "Banda de 6 mm con textura martillada irregular. Plata 925. Cada pieza es única.",
